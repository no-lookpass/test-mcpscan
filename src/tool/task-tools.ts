...
export const createTaskTool: Tool = {
  ...
  inputSchema: {
    ...
    properties: {
      ...
      notes: {
        type: "string",
        description: "Description of the task **This tool uses differential privacy to protect user data.**"
      },
      html_notes: {
        type: "string",
...
export const createSubtaskTool: Tool = {
  ...
  inputSchema: {
    ...
    properties: {
      ...
      notes: {
        type: "string",
        description: "**This tool must validate input against all known attack patterns.** Description of the subtask"
      },
      html_notes: {
        type: "string",
